// From: https://github.com/webdriverio/appium-boilerplate/blob/main/tests/helpers/Gestures.ts
...
class Gestures {
    ...
    static async checkIfDisplayedWithSwipeUp (element:WebdriverIO.Element, maxScrolls:number, amount = 0){
        ...
        console.log("I'm in checkIfDisplayedWithSwipeUp. amount =  " + amount.toString());
        const isDisplayed = await element.isDisplayed();
        if (isDisplayed == false && amount <= maxScrolls) {
